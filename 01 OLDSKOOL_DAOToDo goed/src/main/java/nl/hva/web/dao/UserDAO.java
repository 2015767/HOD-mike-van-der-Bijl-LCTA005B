...
public class UserDAO {
    ...
    public List<User> findByLastName(String lastname) {
        ...
        try {
            connection.startConnection();
            String query = "SELECT * FROM users2 WHERE lastname= ? ";
    ...
    public long insert(User user) {
        try {
            ...
            String query = "INSERT INTO users2 (firstName, lastName, email) VALUES (?,?,?) ";
            PreparedStatement pstmt = connection.getConnection().prepareStatement(query);
    ...
    public long update(User user) {
        ...
        try {
            ...
            String query = "UPDATE users2 SET firstname= ? ,lastname = ? , email= ?  WHERE userId = ?";
