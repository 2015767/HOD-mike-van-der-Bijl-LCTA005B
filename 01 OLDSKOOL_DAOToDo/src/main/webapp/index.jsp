...
<html>
    ...
    <body>
        ...
        <table>
            ...
            <form method="post" action="CreateUser">      
                <td> Create user<td>
                <td><input type="submit" value="Create User" style="color:red"/></td>
            </form>
        </tr>
        <tr>
    ...
    <form method="post" action="ReadUser">      
        ...
        <td><input type="submit" value="Search User by Name" style="color:red"/></td>
    </form>
</tr>  
<tr>
<form method="post" action="ReadUserByID">      
    <td> Read user part III: Search by ID<td>
    <td><input type="submit" value="Search User by ID" style="color:red"/></td>
</form>
</tr>  
<tr>
<form method="post" action="ReadUserToUpdate">      
    <td> Update user<td>
    <td><input type="submit" value="Update User" style="color:red"/></td>
</form>
</tr>
<tr>
